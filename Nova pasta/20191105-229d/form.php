...
<li class='field_block' id='field_2_div'><div class='col_label'>
	<label class='form_field'>Senha:</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
	<input type="password" name="field_2"  id="field_2" value="<?php  phpfmg_hsc("field_2"); ?>" class='text_box'>
	<div id='field_2_tip' class='instruction'></div>
	</div>
</li>

<li class='field_block' id='field_3_div'><div class='col_label'>
	<label class='form_field'>Data de Nascimento:</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_4_div'><div class='col_label'>
	<label class='form_field'>Possui diabetes?</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
	<?php phpfmg_radios( 'field_4', "Tipo 1|Tipo 2|Não Possuo|Prefiro não dizer" );?>
